...
<head>
    ...
    <style>
        ...
        #copyBtn { background: #25d366; display: none; } /* يظهر بعد التوليد */
        
        .fire-card { width: 250px; padding: 15px; background: #000; border: 2px solid #ff4500; border-radius: 15px; box-shadow: 0 0 20px #ff4500; text-align: center; color: #ffcc00; margin: 20px auto; }
    ...
    <script>
        function generateCard() {
            ...
            reader.onload = function(e) {
                ...
                img.onload = function() {
                    ...
                    const cardHtml = `<div class="fire-card" data-category="${cat}">
                    ...
                    window.currentHtml = cardHtml; // حفظ الكود للمتغير
                };
        ...
        function copyCode() {
            navigator.clipboard.writeText(window.currentHtml).then(() => {
                alert("تم نسخ الكود! اذهب للموقع وألصقه (Paste).");
            });
        }
    </script>
</body>
